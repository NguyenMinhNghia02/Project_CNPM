...
import views.MuonTraFrame.MuonCoSoVatChatPhongBanJFrame;
    ...
    private void xoaCoSoVatChatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewBtnActionPerformed
    	if(validateValueInForm()) {
            ...
            try {
            	...
            	coSoVatChatService.themSoLuongCoSoVatChat(tenCoSoVatChatDetail.getText(),  Integer.parseInt(soLuongXoaJtf.getText()), lyDoJtf.getText());
