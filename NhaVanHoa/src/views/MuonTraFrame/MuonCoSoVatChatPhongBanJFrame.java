...
public class MuonCoSoVatChatPhongBanJFrame extends javax.swing.JFrame {

	 /**
	  * @wbp.parser.constructor
	  */
	 public MuonCoSoVatChatPhongBanJFrame(JPanel jpnView, JFrame parentJFrame) {
	    ...
	    private void addCoSoVatChatPhongBanMuonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addNewBtnActionPerformed
	    	if(validateValueInForm()) {
	    		if(checkCoSoVatChat) {
	    			...
	    			coSoVatChat.setTenCoSoVatChat(tenCoSoVatChatPhongBanJcb.getSelectedItem().toString()+"");
...
//			}
	    ...
	    public List<CoSoVatChatModel> getCoSoVatChatMuon() {
	    	return listCoSoVatChatMuon;
	    }
	    
	    public List<PhongBanModel> getPhongBanMuon() {
	    	return listPhongBanMuon;
	    }
